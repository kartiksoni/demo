    ...
    <div class="two-colls">
      ...
      <div class="two-colls-right">
                        ...
                        <div class="cat-list-content">
                          ...
                          <div class="cat-list-content-r">
                            ...
                            <!--  <nav class="stars">
                              ...
                              <a href="/addproduct/<?php echo $FoodsMenu->id;?>" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Select</a>   
                            </div>
                          </div>
                          <div class="clear"></div>
                        </div>
       ...
       <?php } ?>
            ...
            <div class="clear"></div>
           <?php echo $details->appends(array('food' => $FoodsMenu->foodname,'restaurants' => $FoodsMenu ->restaurants_name ))->links(); ?>
