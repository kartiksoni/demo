...
<form class="form-horizontal regi-form" role="form">
    @if (Spark::usesTeams() && Spark::onlyTeamPlans())
        ...
        <div class="form-group" :class="{'has-error': registerForm.errors.has('team')}" v-if=" ! invitation">
            ...
            <div class="col-md-6">
                ...
                <span class="error" v-show="registerForm.errors.has('team')">
        ...
        @if (Spark::teamsIdentifiedByPath())
            ...
            <div class="form-group" :class="{'has-error': registerForm.errors.has('team_slug')}" v-if=" ! invitation">
                ...
                <div class="col-md-6">
                    ...
                    <p class="error" v-show=" ! registerForm.errors.has('team_slug')">
                        This slug is used to identify your team in URLs.
                    </p>

                    <span class="error" v-show="registerForm.errors.has('team_slug')">
    ...
    <div class="form-group" :class="{'has-error': registerForm.errors.has('name')}">
        ...
        <div class="col-md-6">
            ...
            <span class="error" v-show="registerForm.errors.has('name')">
    ...
    <div class="form-group" :class="{'has-error': registerForm.errors.has('email')}">
        ...
        <div class="col-md-6">
            ...
            <span class="error" v-show="registerForm.errors.has('email')">
    ...
    <div class="form-group" :class="{'has-error': registerForm.errors.has('password')}">
        ...
        <div class="col-md-6">
            ...
            <span class="error" v-show="registerForm.errors.has('password')">
    ...
    <div class="form-group" :class="{'has-error': registerForm.errors.has('password_confirmation')}">
        ...
        <div class="col-md-6">
            ...
            <span class="error" v-show="registerForm.errors.has('password_confirmation')">
    ...
    <div v-if=" ! selectedPlan || selectedPlan.price == 0">
        <div class="form-group" :class="{'has-error': registerForm.errors.has('terms')}">
            <div class="col-md-6 col-md-offset-4">
                <div class="checkbox">
                    ...
                    <span class="error" v-show="registerForm.errors.has('terms')">
        ...
        <div class="form-group">
            <div class="col-md-6 col-md-offset-4">
                <button class="authorize-btn " @click.prevent="register" :disabled="registerForm.busy">
